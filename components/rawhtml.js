...
<div class="movie-list-wrapper">
    <div class="containerbox">
        <div class="heading_top">
            <h3>Exclusive Movies on ZEE5</h3>
            <a href="more2.html">More <i class="fa-solid fa-angle-right"></i></a>
        </div>
        
        <div class="cardbox_container">
            <!-- card 1 -->
            <div class="cardbox">
                <img src="../img/card1.webp" alt="Mithya">
            ...
            <!-- card 2 -->
            <div class="cardbox">
                <img src="../img/card2.webp" alt="Mithya">
                <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
                <div class="text_content">
                    <h2>Mithya</h2>
                    <div class="bottom_text">
            ...
            <!-- card 3 -->
            <div class="cardbox">
                <img src="../img/card3.webp" alt="Mithya">
                <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
                <div class="text_content">
                    <h2>Mithya</h2>
                    <div class="bottom_text">
                ...
                <!-- card 4 -->
            <div class="cardbox">
                <img src="../img/card5.webp" alt="Mithya">
                <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
                <div class="text_content">
                    <h2>Mithya</h2>
                    <div class="bottom_text">
            ...
            <!-- card 5 -->
            <div class="cardbox">
                <img src="../img/card6.webp" alt="Mithya">
                <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
                <div class="text_content">
                    <h2>Mithya</h2>
                    <div class="bottom_text">
            ...
            <!-- card 6 -->
            <div class="cardbox">
                <img src="../img/card7.webp" alt="Mithya">
                <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
                <div class="text_content">
                    <h2>Mithya</h2>
                    <div class="bottom_text">
            ...
            <!-- card 8 -->
            <div class="cardbox">
            <img src="../img/card8.webp" alt="Mithya">
            <div class="crownicon"><a href="#"><i class="fa-solid fa-crown"></i></a></div>
            <div class="text_content">
                <h2>Mithya</h2>
                <div class="bottom_text">
...
<div class="movie-list-wrapper">
    <div class="containerbox">
        <div class="heading_top">
            <p>ZEE5 Spark</p>
            <a href="./more.html">More <i class="fa-solid fa-angle-right"></i></a>
        </div>
    ...
    <!-- ZEEPLEX ADDED  <div id="zeeplex"></div> +++++++++++++++ -->
...
var  movieLists = document.querySelectorAll(".cardbox_container");
